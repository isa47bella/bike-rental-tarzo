...
const CONTRATTO_TERMS = {
  it: {
    ...
    conditions: [
      `Il locatario si assume la completa responsabilità dell'oggetto/i che prende in noleggio, dichiarando di essere idoneo e capace di usarlo, senza creare rischi a sé stesso e a terzi.`,
      ...
      `Il presente contratto deve essere esclusivamente accettato e firmato da persona maggiorenne, anche in nome e per conto di più persone o di un gruppo, rendendosi responsabile di tutte le voci del contratto ed esibendo un documento di identità valido.`,
  ...
  de: {
    ...
    conditions: [
      ...
      `Dieser Ausschluss der zivil- und strafrechtlichen Haftung umfasst insbesondere Schadensersatzansprüche wegen Personen- und Sachschäden, die sowohl aus Verschulden als auch aus Gefährdung entstehen, unabhängig von ihrer rechtlichen Ursache.`,
